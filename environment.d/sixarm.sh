...
OPT=$OPT:/opt/sixarm/markdown-read-to-headline/bin
OPT=$OPT:/opt/sixarm/markdown-text-to-bullet-lists/bin  
OPT=$OPT:/opt/sixarm/markdown-text-to-link-urls/bin
OPT=$OPT:/opt/sixarm/markdown-file-toc-generator/bin
